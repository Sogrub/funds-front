...
import { createSubscription, editSubscription, getSubscriptions } from "@shared/services/subscription.services";
  ...
  return (
    <Fragment>
      ...
      <Drawer 
        ...
        slotProps={{
          paper: {
            className: "flex flex-col gap-4 p-4 rounded-lg bg-gray-800! text-white! w-screen h-screen md:w-2xl",
          },
        }}
        ModalProps={{
          className: "z-[1000]!",
